...
public class TimeUtil {
    ...
    public static String since(long l) {
        return "Took " + TimeUtil.convertString(System.currentTimeMillis() - l, 1, TimeUnit.FIT) + ".";
    }
    ...
    public static String MakeStr(long l) {
        return TimeUtil.convertString(l, 1, TimeUnit.FIT);
    }

    public static String MakeStr(long l, int n) {
        return TimeUtil.convertString(l, n, TimeUnit.FIT);
    }
